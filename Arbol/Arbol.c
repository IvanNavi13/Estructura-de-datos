...
struct Arbol *
AgregarElemento (struct Arbol *raiz, int dato)
{
...
void
BuscarElemento (struct Arbol *raiz, int dato)
{
  if (raiz == NULL)
    {
      return;
...
struct Arbol *
EliminarElemento (struct Arbol *raiz, int dato)
{
